...
from pricing_models.mtpl_frequency.spec import MODEL_CONFIG as MTPL_FREQUENCY_CONFIG
...
MODEL_CONFIGS: dict[str, ModelBuildConfig] = {
    MTPL_FREQUENCY_CONFIG.model_key: MTPL_FREQUENCY_CONFIG,
}
...
def get_model_config(model_key: str) -> ModelBuildConfig:
    try:
