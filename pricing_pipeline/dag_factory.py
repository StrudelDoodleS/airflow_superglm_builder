...
from pricing_pipeline.manifest import new_manifest_id
from pricing_pipeline.migrations import apply_migrations
from pricing_pipeline.model_spec import ModelSpec
from pricing_pipeline.pipeline import publish_model_export, train_and_export_model
    ...
    *,
    ...
    def _pricing_model_dag():
        ...
        def prepare_dataset() -> str:
            ...
            spec.dataset.load_raw(engine)
            manifest_id = new_manifest_id(spec.dataset.dataset_name)
            return spec.dataset.create_manifest(engine, manifest_id=manifest_id)
